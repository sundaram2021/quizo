...
const Question = ({ question, id, setNumSubmitted, setNumCorrect }: QuestionProps) => {
    ...
    const handleAnswerSubmit = (e: any) => {
        ...
        setNumSubmitted((prevNumSubmitted:number) => prevNumSubmitted + 1)
        ...
        if (isCorrect()) {
            setNumCorrect((prevNumCorrect : number) => prevNumCorrect + 1)
            setIsExplained(true)
        }
    }
